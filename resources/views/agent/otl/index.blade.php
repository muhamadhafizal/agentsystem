...
@section('content')
      ...
      <div class="row">
                        ...
                        <a href="{{ route('addotl') }}"><button type="button" class="btn btn-primary">Add OTL</button></a>
                        </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach($offers as $offer)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('detailsotl', $offer->id) }}"><span class="badge badge-primary">view</span>  | &nbsp 
                                                    <a href="{{ route('editotl', $offer->id) }}"><span class="badge badge-success">edit</span> 
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
