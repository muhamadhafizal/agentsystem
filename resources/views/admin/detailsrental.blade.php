	                    ...
	                    <div class="card">
	                        ...
	                        <div class="card-body card-block">
	                            ...
	                            <div class="form-group">
                                    ...
                                    <a href="{{ route('allrentals') }}"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left"></i></button></a>&nbsp<button type="button" class="btn btn-primary" onclick="window.location='{{ action('RentalController@edit', $rentaldetails->id) }}'">edit</button>
	                                </div>
	                            </div>
	                        </form>
	                        </div>
