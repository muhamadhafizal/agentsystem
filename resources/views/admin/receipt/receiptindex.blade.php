...
@section('content')
      ...
      <div class="row">
                        ...
                        <a href="{{ route('addreceipt') }}"><button type="button" class="btn btn-primary">Add Receipt</button></a>
                        </div>
                </div>
                                ...
                                <table id="example" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    @foreach($receipt as $data)
                                        <tr>
                                            ...
                                            <td><a href=""><span class="badge badge-primary">print</span>  | &nbsp <a onclick="return confirm('Are you sure you want to delete?')" href="{{ action('ReceiptController@destroy', $data->id) }}"><span class="badge badge-danger">delete</span></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
