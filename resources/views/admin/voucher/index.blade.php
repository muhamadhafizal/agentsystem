                                ...
                                <table id="example" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    @foreach($voucher as $data)
                                        <tr>
                                            ...
                                            <td>{{$data->pay_to}}</td>
                                            <td><a href="{{ route('detailsvoucher', $data->id) }}"><span class="badge badge-primary">view</span>  | &nbsp 
                                                <a href="{{ route('editvoucher', $data->id) }}"><span class="badge badge-success">edit</span>  | &nbsp 
                                                <a onclick="return confirm('Are you sure you want to delete?')" href="{{ action('VoucherController@destroy', $data->id) }}"><span class="badge badge-danger">delete</span></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
