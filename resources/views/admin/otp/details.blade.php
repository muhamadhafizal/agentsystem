            ...
            <div class="col-md-12">
                ...
                <div class="row" style="height:10px"></div>
                    ...
                    <div class="row" style="height:11px">
                        <div class="col-1"></div>
                        <div class="col-6">
                            <p style="font-size:11px">BLOCK A 04-10 PUSAT PERDAGANGAN EKOFLORA</p>
                        </div>
                    </div>
                    <div class="row" style="height:11px">
                        <div class="col-1"></div>
                        <div class="col-6">
                            <p style="font-size:11px">JALAN EKOFLORA 7/3 TAMAN EKOFLORA</p>
                        </div>
                    </div>
                    <div class="row" style="height:11px">
                        <div class="col-1"></div>
                   ...
                   <br>
                    ...
                    <div class="row" style="line-height:10%">
                        <div class="col-1"></div>
                        <div class="col-9">
                            <p style="font-size:11px">before or after loan approved, the earnest deposit shall be forfeited to the vendor and neither party shall have</p>
                        </div>
                    </div>
                    <div class="row" style="line-height:10%">
                        <div class="col-1"></div>
