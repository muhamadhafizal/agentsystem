	    ...
	    <div class="section__content section__content--p30">
	        <div class="container-fluid">
                ...
                <div class="col-lg-2">
                    ...
                    <a href="{{ route('listvoucherbillion') }}"><button class="btn btn-primary"> back</button></a>
                    </div>
                    </div>
	                    <div class="card">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('storevoucherbillion') }}">
	                        	     {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12">
                                                ...
                                                <input type="text" name="vouchernum" placeholder="SB/2022/XXXX" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
